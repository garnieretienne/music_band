class Admin::PublicationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @publication.save
        format.html { redirect_to admin_publication_path(@publication), notice: 'Publication was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @publication.update(publication_params)
        format.html { redirect_to admin_publication_path(@publication), notice: 'Publication was successfully updated.' }
